                ...
                success: function (res) {
                    ...
                    if (res.data.length > 0) {
                        for (var i = 0; i < res.data.length; i++) {
                            ...
                            html += "<li class=\"item\"><a href=\""+basePath+"/picture/detail/"+picture.pictureId+"\" class=\"picture\" target=\"_rsOpen\" title=\"\" height=\"680px\" width=\"1200px\"><img src=\""+basePath + picture.path + "\"></a>" +
