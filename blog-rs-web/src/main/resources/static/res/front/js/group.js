            ...
            success : function (json) {
                ...
                for(var i=0;i<data.length;i++){
                    ...
                    html += data[i].content + "<div class='pull-right'><a href='javascript:group.commentReply("+data[i].id+")'>回复</a></div></div>" +
                        "<form class=\"form-horizontal rs_form\" action=\""+groupPath+"/comment/"+groupTopicId+"\" method=\"post\" id='comment-form-"+data[i].id+"' style='display: none;' callback='reload'>" +
                        ...
                        "<input type=\"submit\" value=\"回复\" class=\"pull-right btn btn-primary mg-t-10 rs-submit\"></div></form></div></div>";
                }
