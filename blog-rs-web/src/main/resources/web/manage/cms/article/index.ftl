...
<head>
    ...
    <title>文章管理 - ${SITE_NAME} - rs后台管理系统 - Powered By rs</title>
                ...
                <div class="col-md-10">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">
                                <a href="${managePath}/cms/article/add" target="_rsOpen"
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="${managePath}/cms/article/edit/${article.id}" target="_rsOpen"
