...
<head>
    ...
    <title>友情链接管理 - ${SITE_NAME} - rs后台管理系统 - Powered By rs</title>
                ...
                <div class="col-xs-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">
                                <a href="${managePath}/link/add" target="_rsOpen"
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <#if link.status=0>
                                        <a class="marg-l-5" target="_rsLink" href="${managePath}/link/enable/${link.id}" confirm="确定要启用友情链接吗？" callback="reload">
                                            <span class="label label-danger">禁用</span>
                                        </a>
                                        <#else>
                                        <a class="marg-l-5" target="_rsLink" href="${managePath}/link/enable/${link.id}" confirm="确定要禁用友情链接吗？" callback="reload">
                                    ...
                                    <td>
                                        <a href="${managePath}/link/edit/${link.id}" target="_rsOpen"
                                           title="修改友情链接" width="800px" height="500px">
                                            <span class="label label-info">修改</span>
                                        </a>
                                        <a class="marg-l-5" target="_rsLink"
...
<script type="text/javascript">
    $(function () {
        $(".pagination").rs_page("rsBlogPageForm");
    });
</script>
</body>
</html>
