...
<head>
    ...
    <title>图片管理 - ${SITE_NAME} - rs后台管理系统 - Powered By rs</title>
                                    ...
                                    <li>
                                        ...
                                        <div class="mailbox-attachment-info">
                                            ...
                                            <span class="mailbox-attachment-size">
                                                 <a class="marg-l-5" target="_rsLink" href="${managePath}/picture/delete/${picture.pictureId}" confirm="确定要删除图片吗？" callback="reload">
