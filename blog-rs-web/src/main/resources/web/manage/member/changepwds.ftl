...
<head>
    ...
    <title>修改密码 - ${SITE_NAME} - rs后台管理系统 - Powered By rs</title>
...
<div class="wrapper">
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal rs_form" role="form" action="${managePath}/member/changepwd" method="post" onsubmit="return false;" callback="reload">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button type="submit" class="btn btn-info rs-submit">确定修改</button>
                        </div>
                    </div>
                </form>
            </div>
