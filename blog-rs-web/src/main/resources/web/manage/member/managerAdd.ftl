...
<head>
    ...
    <title>授权管理员 - ${SITE_NAME} - rs后台管理系统 - Powered By rs</title>
...
<div class="wrapper">
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal rs_form" role="form" action="${managePath}/member/managerAdd" method="post" callback="parentReload">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button type="submit" class="btn btn-info rs-submit">确定授权</button>
                        </div>
                    </div>
                </form>
            </div>
