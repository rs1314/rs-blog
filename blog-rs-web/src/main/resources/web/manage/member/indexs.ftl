...
<head>
    ...
    <title>会员管理 - ${SITE_NAME} - rs后台管理系统 - Powered By rs</title>
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <#if member.status=-1>
                                        <a class="marg-l-5" target="_rsLink" href="${managePath}/member/isenable/${member.id}" confirm="确定要启用会员吗？" callback="reload">
                                            <span class="label label-danger">禁用</span>
                                        </a>
                                        <#else>
                                        <a class="marg-l-5" target="_rsLink" href="${managePath}/member/isenable/${member.id}" confirm="确定要禁用会员吗？" callback="reload">
                                            <span class="label label-success">启用</span>
                                        </a>
                                        </#if>
                                    </td>
                                    <td>
                                        <a href="${managePath}/member/changepwd/${member.id}" target="_rsOpen"
