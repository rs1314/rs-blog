...
<head>
    ...
    <title>群组分类管理 - ${SITE_NAME} - rs后台管理系统 - Powered By rs</title>
                ...
                <div class="col-xs-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">
                                <a href="${managePath}/group/type/add" target="_rsOpen"
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="${managePath}/group/type/edit/${groupType.id}" target="_rsOpen"
