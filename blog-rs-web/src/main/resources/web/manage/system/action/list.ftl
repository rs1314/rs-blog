...
<head>
    ...
    <title>会员动态类型 - ${SITE_NAME} - rs后台管理系统 - Powered By rs</title>
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <#if action.status=1>
                                            <a class="marg-l-5" target="_rsLink" href="${managePath}/system/action/isenable/${action.id}" callback="reload">
                                    ...
                                    <td>
                                        <a href="${managePath}/system/action/edit/${action.id}" target="_rsOpen" title="编辑动态类型" height="350px">
