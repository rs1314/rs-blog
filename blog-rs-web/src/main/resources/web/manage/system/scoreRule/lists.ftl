...
<head>
    ...
    <title>积分规则 - ${SITE_NAME} - rs后台管理系统 - Powered By rs</title>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <#if scoreRule.status=0>
                                            <a class="marg-l-5" target="_rsLink" href="${managePath}/system/scoreRule/enabled/${scoreRule.id}" callback="reload">
                                    ...
                                    <td>
                                        <a href="${managePath}/system/scoreRule/edit/${scoreRule.id}" target="_rsOpen" title="编辑积分规则" height="480px" callback="reload">
