...
<head>
    ...
    <title>系统设置 - ${SITE_NAME} - rs后台管理系统 - Powered By rs</title>
    ...
    <script src="${basePath}/res/common/js/rs.js"></script>
                ...
                <div class="tab-content">
                    <div id="tab-1" class="tab-pane active">
                        <div class="panel-body">
                            <form class="form-horizontal rs_form" role="form" action="${managePath}/system/config/baseUpdate" method="post">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-1 col-sm-10">
                                        <button type="submit" class="btn btn-info rs-submit">保存</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div id="tab-2" class="tab-pane">
                        <div class="panel-body">
                            <form class="form-horizontal rs_form" role="form" action="${managePath}/system/config/memberUpdate" method="post">
                                <div class="form-group">
                    ...
                    <div id="tab-3" class="tab-pane">
                        <div class="panel-body">
                            <form class="form-horizontal rs_form" role="form" action="${managePath}/system/config/cmsUpdate" method="post">
                                <div class="form-group">
                    ...
                    <div id="tab-4" class="tab-pane">
                        <div class="panel-body">
                            <form class="form-horizontal rs_form" role="form" action="${managePath}/system/config/weiboUpdate" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        默认为微博，如果需要修改微博访问路径，请修改rs.properties中weiboPath的值
                                    </div>
                                </div>
                                <div class="form-group">
                    ...
                    <div id="tab-5" class="tab-pane">
                        <div class="panel-body">
                            <form class="form-horizontal rs_form" role="form" action="${managePath}/system/config/groupUpdate" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        默认为群组，如果需要修改群组访问路径，请修改rs.properties中groupPath的值
                                    </div>
                                </div>
                                <div class="form-group">
