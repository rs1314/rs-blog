...
<head>
    ...
    <title>rs后台管理首页 - ${SITE_NAME} - rs后台管理系统 - Powered By rs</title>
            ...
            <div class="box-body">
                <div class="row">
                    <div class="alert alert-info alert-dismissible">
                        感谢您使用rs，rs正在不断完善中，可以向我们提出宝贵的建议或意见，rs的成长需要大家的支持。
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <p>我们提供基于rs的二次开发、模板定制服务，具体费用请联系我们。</p>
                            <p>同时，我们也提供以下服务：</p>
                            <ol>
                                <li>网站定制开发</li>
                                <li>仿站服务</li>
                                            ...
                                            <div class="panel-body">
                                                <div class="alert alert-success">
                                                    <ul>
                                                        ...
                                                        <li>修复：如果应用部署在子目录下，如/rs，使用富文本编辑器上传图片时，图片无法显示问题，临时修复方法</li>
