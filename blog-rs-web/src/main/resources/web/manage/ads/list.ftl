...
<head>
    ...
    <title>广告管理 - ${SITE_NAME} - rs后台管理系统 - Powered By rs</title>
                ...
                <div class="col-xs-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">
                                <a href="${managePath}/ads/add" target="_rsOpen"
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <#if ads.status=0>
                                        <a class="marg-l-5" target="_rsLink" href="${managePath}/ads/enable/${ads.id}" confirm="确定要启用广告吗？" callback="reload">
                                            <span class="label label-danger">禁用</span>
                                        </a>
                                        <#else>
                                        <a class="marg-l-5" target="_rsLink" href="${managePath}/ads/enable/${ads.id}" confirm="确定要禁用广告吗？" callback="reload">
                                            <span class="label label-success">启用</span>
                                        </a>
                                        </#if>
                                    </td>
                                    <td>
                                        <a href="${managePath}/ads/edit/${ads.id}" target="_rsOpen"
