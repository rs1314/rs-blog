...
<head>
    ...
    <title>添加标签 - ${SITE_NAME} - rs后台管理系统 - Powered By rs</title>
...
<div class="wrapper">
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal rs_form" role="form" action="${managePath}/tag/save" method="post" callback="parentReload">
