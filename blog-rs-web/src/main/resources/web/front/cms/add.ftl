...
<head>
    ...
    <title>发布文章 - ${SITE_NAME} - Powered By rs</title>
    ...
    <div class="main-content">
        <div class="row">
            <div class="col-md-12 article-detail">
                <form class="form-horizontal rs_form" role="form" action="${basePath}/article/save" method="post" onsubmit="ckUpdate();" callback="_success">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            ...
                            <a href="${basePath}/article/list" class="btn btn-default rs-submit">取消</a>
                        </div>
                    </div>
                </form>
            </div>
