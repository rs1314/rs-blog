...
<head>
    ...
    <title>${article.title} - ${article.articleCate.name} - ${SITE_NAME} - Powered By rs</title>
                            ...
                            <#if loginUser?? && (loginUser.id == article.memberId || loginUser.isAdmin &gt; 0)>
                                <div class="dropdown dropdown-hover">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="${basePath}/article/delete/${article.id}" confirm="确定要删除文章吗？" target="_rsLink" callback="deleteSuccess">删除</a></li>
                ...
                <div class="comments panel">
                    ...
                    <header>
                        <div class="reply-form">
                            <form class="form-horizontal rs_form" action="${basePath}/article/comment/${article.id}"
                                ...
                                <div class="form-group comment-user">
                                    <input type="submit" value="评论"
                                           class="pull-right btn btn-primary mg-t-10 rs-submit">
                                </div>
                            </form>
                        </div>
                    </header>
