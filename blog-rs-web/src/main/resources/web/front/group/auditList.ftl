...
<head>
    ...
    <title>审核帖子 - ${group.name} - ${GROUP_ALIAS} - ${SITE_NAME} - Powered By rs</title>
                                ...
                                <div class="item-content">
                                    ...
                                    <div class="text">
                                        ...
                                        <p>
                                            ...
                                            <a href="${groupPath}/audit/${topic.id}" class="btn-link" target="_rsLink" confirm="确定审核通过该帖子吗？" callback="reload">
                                                <span class="label label-badge label-info">审核</span>
                                            </a>
                                            <a href="${groupPath}/delete/${topic.id}" class="btn-link" target="_rsLink" confirm="确定要删除该帖子吗？" callback="reload">
