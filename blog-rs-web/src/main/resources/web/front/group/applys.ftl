...
<head>
    ...
    <title>申请${GROUP_ALIAS} - ${SITE_NAME} - Powered By rs</title>
    ...
    <div class="main-content">
        <div class="row">
            <div class="col-md-12 article-detail">
                <form class="form-horizontal rs_form" role="form" action="${groupPath}/apply" method="post" callback="applySuccess">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button type="submit" class="btn btn-info rs-submit">申请${GROUP_ALIAS}</button>
                        </div>
                    </div>
                </form>
            </div>
