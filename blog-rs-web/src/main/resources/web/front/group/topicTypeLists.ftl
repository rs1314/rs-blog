...
<head>
    ...
    <title>帖子分类管理 - ${group.name} - ${GROUP_ALIAS} - ${SITE_NAME} - Powered By rs</title>
            ...
            <div class="col-md-8">
                <div class="panel group-topic-list no-border">
                    <div class="panel-heading">
                        帖子分类管理
                        <a href="${groupPath}/topicTypeAdd/${group.id}" target="_rsOpen" title="添加帖子分类">添加</a>
                    </div>
                        ...
                        <div class="items">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="${groupPath}/topicTypeEdit/${topicType.id}" target="_rsOpen" title="编辑帖子分类">编辑</a>
                                        <a href="${groupPath}/topicTypeDelete/${topicType.id}" target="_rsLink" title="编辑帖子分类" confirm="确定要删除该分类吗？" callback="reload">删除</a>
                                    </td>
                                </tr>
                                </#list>
                                </tbody>
