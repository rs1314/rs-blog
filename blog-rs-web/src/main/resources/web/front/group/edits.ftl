...
<head>
    ...
    <title>修改${GROUP_ALIAS} - ${SITE_NAME} - Powered By rs</title>
    ...
    <div class="main-content">
        <div class="row">
            <div class="col-md-12 article-detail">
                <form class="form-horizontal rs_form" role="form" action="${groupPath}/update"
                      method="post">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <button type="submit" class="btn btn-info rs-submit">修改</button>
