...
<head>
    ...
    <title>修改帖子 - ${SITE_NAME} - Powered By rs</title>
    ...
    <div class="main-content">
        <div class="row">
            <div class="col-md-12 article-detail">
                <form class="form-horizontal rs_form" role="form" action="${groupPath}/topicUpdate" method="post" onsubmit="ckUpdate();" callback="_success">
