...
<head>
    ...
    <title>${weibo.member.name}${WEIBO_ALIAS} - ${SITE_NAME} - Powered By rs</title>
                ...
                <article class="article weibo-detail">
                    ...
                    <div class="info">
                        ...
                        <#if loginUser?? && (loginUser.id == weibo.member.id || loginUser.isAdmin &gt; 0)>
                            <a href="${weiboPath}/delete/${weibo.id}" target="_rsLink" confirm="确定要删除微博吗？" callback="deleteSuccess">删除</a>
                        </#if>
                        </div>
                    </div>
                </article>
                ...
                <div class="comments panel">
                    ...
                    <header>
                        <div class="reply-form">
                            <form class="form-horizontal rs_form" action="${weiboPath}/comment/${weibo.id}" method="post" callback="reload">
