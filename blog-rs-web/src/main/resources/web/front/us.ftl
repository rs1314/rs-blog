...
<head>
    ...
    <title>${member.name}主页 - ${SITE_NAME} - Powered By rs</title>
                ...
                <div class="left">
                    ...
                    <div class="info">
                        ...
                        <p class="operator">
                            ...
                            <a class="label label-primary" href="${basePath}/member/sendMessageBox?mid=${member.id}" target="_rsOpen" title="私信" height="285px">
