...
<head>
    ...
    <title>修改资料 - ${SITE_NAME} - Powered By rs</title>
                    ...
                    <div class="tab-content">
                        <div id="tab-1" class="tab-pane active">
                            <div class="panel-body">
                                <form class="form-horizontal m-t rs_form" action="${basePath}/member/editBaseInfo"
                        ...
                        <div id="tab-2" class="tab-pane">
                            <div class="panel-body">
                                <form class="form-horizontal m-t rs_form"
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-8 col-sm-offset-2">
                                            <input type="submit"
                                                   class="btn btn-primary block full-width m-b rs-submit"
                                                   value="修改">
                                        </div>
                                    </div>
                                </form>
