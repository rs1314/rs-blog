...
<head>
    ...
    <title>图片 - ${SITE_NAME} - Powered By rs</title>
            ...
            <div class="col-md-9 white-bg">
                <div class="panel-heading">
                    ...
                    <span class="pull-right">
                        <a class="btn btn-primary m-t-n4" href="${basePath}/member/picture/uploadPic?albumId=${pictureAlbum.id}" target="_rsOpen" height="400px" width="1200px">上传图片</a>
                    </span>
                </div>
                <div class="cards">
                    ...
                    <div class="col-md-4 col-sm-6 col-lg-3">
                        <div class="card">
                            <a href="${basePath}/picture/detail/${picture.pictureId}" class="picture" target="_rsOpen" title="" height="90%" width="90%">
