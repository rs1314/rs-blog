...
<head>
    ...
    <title>新建相册 - ${SITE_NAME} - Powered By rs</title>
...
<body>
<div class="container">
    <form class="form-horizontal rs_form" role="form" action="${basePath}/member/picture/saveAlbum" method="post" callback="reload">
